...
.controller "ResultsCtrl", ($rootScope, $scope)->
  ...
  $rootScope.contentPromise.then ()->
    ...
    $scope.quip = switch
      when gameStatus.mistakes is 0 and secondsPerQuestion <= 1.3 then "That Was Amazing!"
      when gameStatus.mistakes is 0 and secondsPerQuestion >= 2.5 then "You should go faster."
