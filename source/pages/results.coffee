...
.controller "ResultsCtrl", ($rootScope, $scope)->
  ...
  $rootScope.contentPromise.then ()->
    ...
    $scope.quip = switch
      ...
      when gameStatus.mistakes is 0 and secondsPerQuestion >= 3.0 then "You should go faster."
      ...
      when gameStatus.mistakes <= 1 and secondsPerQuestion <= 2.2 then "Not bad, not bad.."
